...
//import pl.sda.refactoring.customers.CustomerFacade;
//import pl.sda.refactoring.discounts.DiscountCouponsDao;
//
...
//                dao.save(order);
//                var customer = customerFacade.findById(order.getCid()).get();
//                var emailSend = false;
//                if (status == 2) {
...
//    }
//
//    public void setCustomerFacade(CustomerDao customerFacade) {
